  ...
  data() {
    return {
      ...
      tableData: {
        checked: null,//选中行
        basic: [//table的表头和参数名
          { prop: "name", title: "隧道名称", id:1 },
          { prop: "number", title: "结构类型", id:2 },
        ],
        list: [
          {"name":"北岸入洞门","number":"切入式洞门","id":"3","ischecked":false},
        ...
        children: [{
          ...
          children: [{
          ...
          },
            {
              ...
              label: '设施',
              children: [
                {id:1121,label:'监控与通信系统'},
                {id:1122,label:'供配电系统'},
                {id:1123,label:'通风系统'},
                {id:1124,label:'照明系统'},
                {id:1125,label:'消防给排水系统'},
                {id:1126,label:'健康监测系统'},
                {id:1127,label:'其他系统'}
              ]
            }
          ]
