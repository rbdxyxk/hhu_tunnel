      ...
      <el-col :span="18">
        <div v-if="isTableVisual">
          ...
          <el-table ref="tab" :data="tableData" border class="tab-table" @selection-change="handleSelectionChange"
            ...
            <el-table-column prop="czmc" label="处置名称" width="180" >
            </el-table-column>
            ...
            <el-table-column prop="jlr" label="记录人" width="180" >
            </el-table-column>
    ...
    <el-dialog title="添加" :visible.sync="addTableDataVisual" width="35%" :show-close="false">
      <el-form ref="addform" :model="tempData" label-width="10rem">
        ...
        <el-form-item label="编号" style="margin-bottom: 0.6rem;">
          <el-input v-model="tempData['bh']"></el-input>
        </el-form-item>
        <el-form-item label="处置名称" style="margin-bottom: 0.6rem;">
          <el-input v-model="tempData['czmc']"></el-input>
        </el-form-item>
        <el-form-item label="开始时间" style="margin-bottom: 0.6rem;">
          <el-date-picker v-model="tempData['starttime']" type="datetime" placeholder="选择日期时间"
            value-format="yyyy-MM-dd HH:mm:ss">
          </el-date-picker>
        </el-form-item>
        ...
        <el-form-item label="记录人" style="margin-bottom: 0.6rem;">
          <el-input v-model="tempData['jlr']"></el-input>
        </el-form-item>
  ...
  methods: {
    addNodeData() {
      ...
      if (this.selectedNode['id'] === undefined) {
        ...
        var node = this.$refs.treeData.getCurrentNode()
        if (node.label.indexOf("月") != -1){
          this.$message.error("无法在月份下面继续添加节点")
          return
        }
    ...
    getTableData(queryEntity) {
      this.tableData = [{
        id: 1,
        bh: 'M20220128312038112',
        czmc: '病害处置202013',
        starttime: '2022-01-02 14:15:21',
        endtime: '2022-01-21 15:09:06',
        xmly: '隧道土建日常巡查',
        zxr: '土建日常',
        jlr: '土建检查',
        status: 0
