<template>
  <div>
      ...
      <!-- 添加日常巡查弹框 -->
      <el-dialog title="添加日常巡查" :visible.sync="addDialogVisible" width="30%" :before-close="handleClose">
      ...
      <el-dialog title="编辑日常巡查" :visible.sync="editorDialogVisible" width="30%" :before-close="handleClose">
          <el-form ref="form" :model="edditData" label-width="5rem">
              <el-form-item label="开始时间" style="margin-bottom: 0.6rem;">
                  <el-date-picker v-model="edditData.beginDate" type="date" placeholder="选择开始时间"
                      value-format="yyyy-MM-dd">
                  </el-date-picker>
              </el-form-item>
              <el-form-item label="结束时间" style="margin-bottom: 0.6rem;">
                  <el-date-picker v-model="edditData.endDate" type="date" placeholder="选择结束时间" value-format="yyyy-MM-dd">
                  </el-date-picker>
              </el-form-item>
              <el-form-item label="编号" style="margin-bottom: 0.6rem;">
