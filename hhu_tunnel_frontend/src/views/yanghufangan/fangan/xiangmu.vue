      ...
      <el-col :span="18">
        <div v-if="isTableVisual">
          ...
          <el-table ref="tab" :data="tableData" border class="tab-table" @selection-change="handleSelectionChange"
            ...
            <el-table-column label="隧道长度/km" prop="suidaochangdu">
            </el-table-column>
            <el-table-column label="测段起点" prop="ceduanqidian">
            </el-table-column>
            <el-table-column label="测段终点" prop="ceduanzhongdian">
            </el-table-column>
            <el-table-column label="测段号" prop="cdh">
            </el-table-column>
            <el-table-column label="养护方式" prop="cdh">
            </el-table-column>
<!--            <el-table-column label="专项维护次数" prop="zxwhcs">-->
<!--            </el-table-column>-->
            <el-table-column label="养护开始时间" prop="zjwhkssj" width="160">
            </el-table-column>
            <el-table-column label="养护结束时间" prop="zjwhjssj" width="160">
            </el-table-column>
            <el-table-column label="养护状态" prop="whzt">
          ...
          <el-row>
            <el-col :span="5" style="margin-bottom: 1rem;display: flex;">
              <div style="width: 2rem; height: 2rem ;border-style: solid;border-width: 0.1rem;background-color: #006600;"></div>
              <span style="font-size: 15px; margin-left: 1rem; line-height: 2rem;">正常养护</span>
            </el-col>
            <el-col :span="5" style="margin-bottom: 1rem;display: flex;">
              <div style="width: 2rem; height: 2rem ;border-style: solid;border-width: 0.1rem;background-color: #FF0000;"></div>
              <span style="font-size: 15px; margin-left: 1rem; line-height: 2rem;">专项养护</span>
            </el-col>
          </el-row>
